...
import { useStudyInKoreaFileForm } from '../Hooks'
...
export const StudyInKoreaFileForm = ({ id, detailId }: Props) => {
  const { form, isLoading, langError, onSubmit, disabled } = useStudyInKoreaFileForm({ initList: false, extraId: id, detailId })
  const {
    handleSubmit,
    control,
    setValue,
