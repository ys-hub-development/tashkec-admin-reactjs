...
import { useStudyFileForm } from 'Views/Materials/Hooks'
...
export const StudyMaterialFileForm = ({ id, detailId }: Props) => {
  const { form, isLoading, langError, onSubmit, disabled } = useStudyFileForm({
    initList: false,
    extraId: id,
    detailId,
  })
