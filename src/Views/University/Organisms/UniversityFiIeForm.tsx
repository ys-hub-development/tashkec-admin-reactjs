...
import { useUniversityFileForm } from 'Views/University/Hooks'
...
export const UniversityFileForm = ({ id, detailId }: Props) => {
  const { form, isLoading, langError, onSubmit, disabled } = useUniversityFileForm({ initList: false, extraId: id, detailId })
  const {
    handleSubmit,
    control,
    setValue,
